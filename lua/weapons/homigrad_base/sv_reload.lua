...
function SWEP:Reload(time)
	...
	local gripPenalty = org and math.Remap(math.Clamp(org.perfusionGripMul or 1, 0.35, 1), 0.35, 1, 0.25, 0) or 0
	self.StaminaReloadMul = (org and ((2 - (self:GetOwner().organism.stamina[1] / 180)) + ((org.pain / 40) + (org.larm / 3) + (org.rarm / 5)) - (1 - math.Clamp(org.recoilmul or 1,0.45,1.4)) + gripPenalty) or 1)
